...
val IS_FABRIC_PERMISSION_API_LOADED = QuiltLoader.isModLoaded("fabric-permissions-api-v0")

public fun require(permission: String, defaultValue: Boolean): Predicate<ServerCommandSource> {
...
public fun require(permission: String, opLevel: Int): Predicate<ServerCommandSource> {
    if (IS_FABRIC_PERMISSION_API_LOADED) {
...
public fun check(source: ServerCommandSource, permission: String, fallback: Boolean): Boolean {
    if (IS_FABRIC_PERMISSION_API_LOADED) {
